      ...
      return new Promise((function (resolve) {
        ...
        for (var i = 0; i < keyList.length; ++i) {
          ...
          if (metadata.type === "morphology_json") {
            ...
            // console.log('GLTF settings');
            // console.log(unit);
            unit.group = this.groups.frontCyl; // Set group to the appropriate one
      ...
      return function (jsonString) {
        ...
        loader.load(
          ...
          function (gltf) {
            ...
            //var mesh = new THREE.Mesh(gltf.scene.children[0].children[0].geometry, material);
            ...
            object.geometry.scale(0.008, 0.008, 0.008);
            object.geometry.computeBoundingBox();
            var group = new THREE.Group();
            group.add(object);
            // object.add(mesh);
            _this._registerObject(key, unit, group);
          },
