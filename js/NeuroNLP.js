...
requirejs.config({
  ...
  paths: {
    ...
    graphvis: '//cdn.jsdelivr.net/gh/fruitflybrain/neuronlp.graphutils@96b7154d4196200952573c3e65fc5cd00194e75c/js/graphvis',
    sigma: '//cdn.jsdelivr.net/gh/fruitflybrain/neuronlp.graphutils@96b7154d4196200952573c3e65fc5cd00194e75c/sigma.js/sigma.min',
...
require([
   ...
   */
    ...
    ffbomesh.createUIBtn("viewMedullaColumnIndex", "fa-address-book", "View Medulla Column Index");
    ...
    ffbomesh.on('viewMedullaColumnIndex', (function() { window.NeuroNLPUI.viewMedullaColumnIndex(); }));
