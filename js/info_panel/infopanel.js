...
moduleExporter("InfoPanel",[
  'jquery',
  '//cdn.jsdelivr.net/gh/fruitflybrain/ffbo.neuronlp@hemibrain/js/info_panel/summarytable',
  '//cdn.jsdelivr.net/gh/fruitflybrain/ffbo.neuronlp@hemibrain/js/info_panel/connsvg',
  '//cdn.jsdelivr.net/gh/fruitflybrain/ffbo.neuronlp@hemibrain/js/info_panel/conntable',
  ],
  function(
    $,
    SummaryTable,
